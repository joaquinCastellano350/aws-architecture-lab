...
export interface CancelFulfillmentCommand {
  readonly schemaVersion: "1.0";
  readonly commandType: "CancelFulfillment";
  readonly operationId: string;
  readonly checkoutId: string;
  readonly reservationId: string;
  readonly correlationId: string;
...
export interface FulfillmentCommandOutcome {
  ...
  readonly checkoutId: string;
  readonly reservationId: string;
  readonly status: "RESERVED" | "CANCELLED" | "HANDED_OFF" | "CAPACITY_UNAVAILABLE" | "RESERVATION_NOT_ACTIVE";
  readonly reservationStatus?: "RESERVED" | "CANCELLED" | "HANDED_OFF";
  readonly [key: string]: unknown;
}
...
export function validateCancelFulfillmentCommand(
  input: unknown,
): FulfillmentContractValidationResult<CancelFulfillmentCommand> {
  if (
    typeof input !== "object" ||
    input === null ||
    (typeof (input as Record<string, unknown>)["schemaVersion"] !== "string" || (input as Record<string, unknown>)["schemaVersion"] !== "1.0") ||
    (typeof (input as Record<string, unknown>)["commandType"] !== "string" || (input as Record<string, unknown>)["commandType"] !== "CancelFulfillment") ||
    (typeof (input as Record<string, unknown>)["operationId"] !== "string" || String((input as Record<string, unknown>)["operationId"]).length < 1 || String((input as Record<string, unknown>)["operationId"]).length > 256) ||
    (typeof (input as Record<string, unknown>)["checkoutId"] !== "string" || String((input as Record<string, unknown>)["checkoutId"]).length < 1 || String((input as Record<string, unknown>)["checkoutId"]).length > 128) ||
    (typeof (input as Record<string, unknown>)["reservationId"] !== "string" || String((input as Record<string, unknown>)["reservationId"]).length < 1 || String((input as Record<string, unknown>)["reservationId"]).length > 256) ||
    (typeof (input as Record<string, unknown>)["correlationId"] !== "string" || String((input as Record<string, unknown>)["correlationId"]).length < 1 || String((input as Record<string, unknown>)["correlationId"]).length > 128) ||
    ...
    return { ok: false, error: "Value does not match CancelFulfillmentCommand" };
  }
  return { ok: true, value: input as CancelFulfillmentCommand };
}
...
export function validateFulfillmentCommandOutcome(
  ...
  if (
    ...
    (typeof (input as Record<string, unknown>)["checkoutId"] !== "string" || String((input as Record<string, unknown>)["checkoutId"]).length < 1 || String((input as Record<string, unknown>)["checkoutId"]).length > 128) ||
    (typeof (input as Record<string, unknown>)["reservationId"] !== "string" || String((input as Record<string, unknown>)["reservationId"]).length < 1 || String((input as Record<string, unknown>)["reservationId"]).length > 256) ||
    (typeof (input as Record<string, unknown>)["status"] !== "string" || !["RESERVED", "CANCELLED", "HANDED_OFF", "CAPACITY_UNAVAILABLE", "RESERVATION_NOT_ACTIVE"].includes((input as Record<string, unknown>)["status"] as string)) ||
    ((input as Record<string, unknown>)["reservationStatus"] !== undefined && (typeof (input as Record<string, unknown>)["reservationStatus"] !== "string" || !["RESERVED", "CANCELLED", "HANDED_OFF"].includes((input as Record<string, unknown>)["reservationStatus"] as string)))
  ) {
